          ...
          <main className="apt-main set" id="appointment-main">
            ...
            <div className="apt-content" id="appointment-content">
              ...
              <section className="services-wrap" id="services-offered">
                <h2 className="service-title" id="services-title">SERVICES OFFERED IN OUR CARDIOLOGY DEPARTMENT</h2>
                ...
                <div className="clinic-service" id="service-cardiac">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>1. Cardiac Consultation</h2>
                      <button 
                        className="book-btn" 
                        id="book-cardiac"
                        onClick={() => handleBook('Cardiac Consultation')}
                      >
                        {selectedServices.includes('Cardiac Consultation') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Comprehensive heart examination and consultation with a cardiologist to assess cardiovascular health, diagnose conditions, and develop treatment plans.</p>
                  </div>
                ...
                <div className="clinic-service" id="service-ecg">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>2. ECG/Heart Monitoring</h2>
                      <button 
                        className="book-btn" 
                        id="book-ecg"
                        onClick={() => handleBook('ECG/Heart Monitoring')}
                      >
                        {selectedServices.includes('ECG/Heart Monitoring') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Advanced cardiac diagnostic testing including electrocardiogram (ECG) and continuous heart rhythm monitoring to evaluate heart function and detect abnormalities.</p>
                  </div>
                  <div className="apt-notes-wrap">
                    <p className="notes-instruction">Add any details or special requests for your appointment here.</p>
                    <textarea 
                ...
                <div className="clinic-service" id="service-followup">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>3. Cardiac Follow-up</h2>
                      <button 
                        className="book-btn" 
                        id="book-followup"
                        onClick={() => handleBook('Cardiac Follow-up')}
                      >
                        {selectedServices.includes('Cardiac Follow-up') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Regular follow-up care for existing cardiac conditions, medication management, and ongoing monitoring of heart health progress and treatment effectiveness.</p>
                  </div>
                  <div className="apt-notes-wrap">
                    <p className="notes-instruction">Add any details or special requests for your appointment here.</p>
                    <textarea 
