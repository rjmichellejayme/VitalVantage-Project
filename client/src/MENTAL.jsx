          ...
          <main className="apt-main set" id="appointment-main">
            ...
            <div className="apt-content" id="appointment-content">
              ...
              <section className="services-wrap" id="services-offered">
                <h2 className="service-title" id="services-title">SERVICES OFFERED IN OUR MENTAL DEPARTMENT</h2>
                ...
                <div className="clinic-service" id="service-psychcon">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>1. Psychiatry Consultations</h2>
                      <button 
                        className="book-btn" 
                        id="book-psychcon"
                        onClick={() => handleBook('Psychiatry Consultations')}
                      >
                        {selectedServices.includes('Psychiatry Consultations') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Book a psychiatry consultation to receive expert care and support for mental health concerns, including anxiety, depression, and stress.</p>
                  </div>
                ...
                <div className="clinic-service" id="service-psychsess">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>2. Psychotherapy Sessions</h2>
                      <button 
                        className="book-btn" 
                        id="book-psychsess"
                        onClick={() => handleBook('Psychotherapy Sessions')}
                      >
                        {selectedServices.includes('Psychotherapy Sessions') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Psychotherapy sessions offer a supportive environment for individuals to address emotional challenges and improve mental well-being through professional therapeutic guidance.</p>
                  </div>
                  <div className="apt-notes-wrap">
                    <p className="notes-instruction">Add any details or special requests for your appointment here.</p>
                    <textarea 
                      className="apt-notes" 
                      name="psychsess-notes"
                      id="psychsess-notes"
                      value={secondNotes}
                ...
                <div className="clinic-service" id="service-conseling">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>3. Conseling Services</h2>
                      <button 
                        className="book-btn" 
                        id="book-conseling"
                        onClick={() => handleBook('Conseling Services')}
                      >
                        {selectedServices.includes('Conseling Services') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Counseling services provide a safe space for individuals to explore personal challenges and receive guidance to enhance emotional well-being and coping skills.</p>
                  </div>
                  <div className="apt-notes-wrap">
                    <p className="notes-instruction">Add any details or special requests for your appointment here.</p>
                    <textarea 
                    className="apt-notes"
                    name="conseling-notes"
                    id="conseling-notes"
                    value={thirdNotes}
