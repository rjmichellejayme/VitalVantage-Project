          ...
          <main className="apt-main set" id="appointment-main">
            ...
            <div className="apt-content" id="appointment-content">
              ...
              <section className="services-wrap" id="services-offered">
                <h2 className="service-title" id="services-title">SERVICES OFFERED IN OUR PEDIATRICS DEPARTMENT</h2>
                ...
                <div className="clinic-service" id="service-wellchild">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>1. Well-Child Check-up</h2>
                      <button 
                        className="book-btn" 
                        id="book-wellchild"
                        onClick={() => handleBook('Well-Child Check-up')}
                      >
                        {selectedServices.includes('Well-Child Check-up') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Book a comprehensive well-child check-up including physical examination, growth monitoring, developmental screening, and immunizations to ensure your child's healthy development.</p>
                  </div>
                ...
                <div className="clinic-service" id="service-vaccination">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>2. Vaccination Services</h2>
                      <button 
                        className="book-btn" 
                        id="book-vaccination"
                        onClick={() => handleBook('Vaccination Services')}
                      >
                        {selectedServices.includes('Vaccination Services') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Professional vaccination services following the recommended childhood immunization schedule to protect your child's health and prevent common diseases.</p>
                  </div>
                  <div className="apt-notes-wrap">
                    <p className="notes-instruction">Add any details or special requests for your appointment here.</p>
                    <textarea 
                ...
                <div className="clinic-service" id="service-sickchild">
                  <div className="services-choose">
                    <div className="service-book">
                      <h2>3. Sick Child Consultation</h2>
                      <button 
                        className="book-btn" 
                        id="book-sickchild"
                        onClick={() => handleBook('Sick Child Consultation')}
                      >
                        {selectedServices.includes('Sick Child Consultation') ? 'Cancel Booking' : 'Book'}
                      </button>
                    </div>
                    <p>Expert medical consultation and care for ill children, including comprehensive diagnosis and treatment of common childhood illnesses and conditions.</p>
                  </div>
                  <div className="apt-notes-wrap">
                    <p className="notes-instruction">Add any details or special requests for your appointment here.</p>
                    <textarea 
                      className="apt-notes"
                      name="sickchild-notes"
                      id="sickchild-notes"
                      value={thirdNotes}
