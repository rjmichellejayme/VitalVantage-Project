    ...
    <>
      <section className='hero'>
        ...
        <div className='right'>
          ...
          <p>
            VitalVantage is a healthcare assistance service that specializes in appointment setting to streamline patient care.
          </p>
        </div>
      </section>
      ...
      <section className='clinics' id='laboratories'>
